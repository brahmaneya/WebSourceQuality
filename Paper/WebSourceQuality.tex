...
%***IMPORTANT***: Need to deal with fully missing tuples, or decide what to change in order to ignore them. 
%***IMPORTANT***: Need to put the prior over S and G somewhere. Additional restrictions on weights. 
% Remove the e^{w1} + ... condition. It is not needed, as photo shows. w_T is not needed either, it can be derived from the w_{g} weights. 
