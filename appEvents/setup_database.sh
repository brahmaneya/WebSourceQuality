...
deepdive sql "copy eventPosVotes from STDIN CSV;" < $APP_HOME/data/positiveVotes.csv
deepdive sql "copy eventPosVotes from STDIN CSV;" < $APP_HOME/data/positiveVotesAcross.csv
deepdive sql "copy eventNegVotes from STDIN CSV;" < $APP_HOME/data/negativeVotes.csv
